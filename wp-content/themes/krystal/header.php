                                                    ...
                                                    <?php
                                                        ...
                                                        if(!empty($home_button_text)) {
                                                            if (false !== strpos(esc_url(get_theme_mod( 'kr_home_button_url' )), 'youtube') || false !== strpos(esc_url(get_theme_mod( 'kr_home_button_url' )), 'vimeo')) {
                                                                ...
                                                                ?>
                                                                    <div class="read-more">
                                                                        <a class="btn video-popup-link" href="<?php echo esc_url(get_theme_mod( 'kr_home_button_url' ));?>"><?php echo esc_attr(get_theme_mod( 'kr_home_button_text' ));?> <i class="fas fa-angle-double-right"></i>
                                                                        </a>
                                                                    </div>  
                                                                <?php
                                                            }
                                                                ...
                                                                ?>
                                                                    <div class="read-more">
                                                                        <a class="btn" href="<?php echo esc_url(get_theme_mod( 'kr_home_button_url' ));?>"><?php echo esc_attr(get_theme_mod( 'kr_home_button_text' ));?> <i class="fas fa-angle-double-right"></i>
                                                                        </a>
                                                                    </div>
                                                                <?php
                                                            }                                                   
                                                        ...
                                                        if(!empty($home_button2_text)) {
                                                            if (false !== strpos(esc_url(get_theme_mod( 'kr_home_button2_url' )), 'youtube') || false !== strpos(esc_url(get_theme_mod( 'kr_home_button2_url' )), 'vimeo')) {
                                                                ...
                                                                ?>
                                                                    <div class="read-more">
                                                                        <a class="btn video-popup-link" href="<?php echo esc_url(get_theme_mod( 'kr_home_button2_url' ));?>"><?php echo esc_attr(get_theme_mod( 'kr_home_button2_text' ));?> <i class="fas fa-angle-double-right"></i>
                                                                        </a>
                                                                    </div>  
                                                                <?php
                                                            }
                                                                ...
                                                                ?>
                                                                    <div class="read-more">
                                                                        <a class="btn" href="<?php echo esc_url(get_theme_mod( 'kr_home_button2_url' ));?>"><?php echo esc_attr(get_theme_mod( 'kr_home_button2_text' ));?> <i class="fas fa-angle-double-right"></i>
                                                                        </a>
                                                                    </div>
                                                                <?php 
                                                            }                                                   
