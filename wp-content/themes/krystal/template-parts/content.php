		...
		<div class="blog-wrapper blog-list wow fadeInUp animated" data-wow-delay="0.2s">
            ...
            <div class="meta-wrapper">
                <div class="meta">
                        ...
                        if(is_sticky()){
                            ?>                                        
                                <span class="meta-item">
                                    <i class="fas fa-thumbtack"></i><?php _e('Sticky Post','krystal') ?>
                                </span> 
                            <?php       
                        }                                
                    ?>              
                    ...
                    <span class="meta-item">
                        <i class="fas fa-comments"></i><a class="post-comments-url" href="<?php the_permalink() ?>#comments"><?php comments_number('0','1','%'); ?> <?php _e('Comments','krystal'); ?></a>
                    </span>
                </div>  
            </div>
